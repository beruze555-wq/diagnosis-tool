...
const ATTR_QUESTIONS = [
  {
    question: 'この結果になった原因は、時間が経てば変わると思いますか？ それとも今後もずっと変わらないと思いますか？',
    leftLabel: 'すぐ変わる',
    rightLabel: 'ずっと変わらない',
  },
  {
    question: 'この原因は今回の場面だけの話だと思いますか？ それとも仕事や学校など他の場面でも同じことが起きると思いますか？',
    leftLabel: 'この場面だけ',
...
export const scenarios: Scenario[] = [
  ...
  },
  {
    ...
    sjtOptions: [
      ...
      { label: 'D', text: '焦りはあるが、自分なりのやり方を見つけながら追いつこうとする' },
    ],
    attributions: ATTR_QUESTIONS,
  },
]
