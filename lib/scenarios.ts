...
export const scenarios: Scenario[] = [
  {
    ...
    attributions: [
      ...
      {
        question: '30件すべてに断られたことは、今回の営業だけで終わる話だと思いますか？ それとも、他の仕事でも同じように影響すると思いますか？',
        leftLabel: '今回の営業だけ',
  ...
  },
  {
    ...
    attributions: [
      ...
      {
        question: '企画が却下されたことは、今回だけで終わる話だと思いますか？ それとも、今後の仕事全般にも当てはまると思いますか？',
        leftLabel: '今回の企画だけ',
  ...
  },
  {
    ...
    attributions: [
      ...
      {
        question: 'ミスをした原因は、この試合だけの話だと思いますか？ それとも、他の場面でも同じことが起きると思いますか？',
        leftLabel: 'この試合だけ',
  ...
  },
  {
    ...
    attributions: [
      ...
      {
        question: '同期が突然辞めるような状況は、今の職場だけの話だと思いますか？ それとも、どこに行っても似たようなことが起きると思いますか？',
        leftLabel: '今の職場だけ',
        rightLabel: 'どこでも起きる',
      },
      {
  ...
  },
  {
    ...
    attributions: [
      ...
      {
        question: '3ヶ月の努力が白紙になったのは、今回だけの話だと思いますか？ それとも、他の仕事でも同じような状況が起きると思いますか？',
  ...
  },
  {
    ...
    attributions: [
      ...
      {
        question: '周囲と差がついたことは、今のインターン先だけの話だと思いますか？ それとも、どんな環境に行っても同じことが起きると思いますか？',
