...
export const scenarios: Scenario[] = [
  {
    ...
    sjtOptions: [
      { label: 'A', text: '昨日断られた理由を1件ずつ振り返り、トークを変えて同じエリアにもう一度行く', tags: ['行動変容', '自己効力'] },
      { label: 'B', text: '上司や先輩に「自分のどこがダメだったか」を具体的に聞きに行く', tags: ['フィードバック志向', 'チーム志向'] },
      { label: 'C', text: '「訪問営業自体が時代に合っていない」と感じ、別の方法を提案する', tags: ['合理化・俯瞰', '行動変容'] },
      { label: 'D', text: '正直やる気が出ないので、とりあえず件数だけこなして早めに切り上げる', tags: ['回避・撤退', '感情制御'] },
    ],
  ...
  },
  {
    ...
    sjtOptions: [
      { label: 'A', text: '「根本的に違う」と言われた部分を具体的に聞きに行き、次の企画に活かす', tags: ['フィードバック志向', '行動変容'] },
      { label: 'B', text: 'チームメンバーの気持ちを立て直すことを最優先にし、食事に誘う', tags: ['チーム志向', '感情制御'] },
      { label: 'C', text: '自分にはこのレベルの企画を作る力がまだないと感じ、しばらく提案を控える', tags: ['回避・撤退'] },
      { label: 'D', text: '「方向性が違う」のは役員側の理解不足だと思い、別ルートで再提案する', tags: ['合理化・俯瞰', '情熱駆動'] },
    ],
  ...
  },
  {
    ...
    sjtOptions: [
      { label: 'A', text: '悔しさをバネに、翌日から自主練の時間を増やす', tags: ['自己効力', '情熱駆動'] },
      { label: 'B', text: '先輩に頭を下げた上で、「具体的にどう改善すべきか」を聞く', tags: ['フィードバック志向', 'チーム志向'] },
      { label: 'C', text: '自分のメンタルの弱さが原因だと感じ、試合に出ること自体を避けたいと思う', tags: ['回避・撤退'] },
      { label: 'D', text: 'ミスは仕方ないと割り切り、チーム全体の課題として捉え直す', tags: ['合理化・俯瞰', '感情制御'] },
    ],
  ...
  },
  {
    ...
    sjtOptions: [
      { label: 'A', text: '感情は脇に置き、まずクライアントへの対応方針を上司と30分以内に決める', tags: ['感情制御', '行動変容'] },
      { label: 'B', text: '同期に直接連絡を取り、引き継ぎで足りない情報を聞き出す', tags: ['フィードバック志向', '行動変容'] },
      { label: 'C', text: '「裏切られた」という気持ちが強く、しばらく仕事に集中できない', tags: ['回避・撤退'] },
      { label: 'D', text: '自分のマネジメント不足（1人に頼りすぎた）と捉え、体制を見直す', tags: ['合理化・俯瞰', '行動変容'] },
    ],
  ...
  },
  {
    ...
    sjtOptions: [
      { label: 'A', text: '週末のうちに新しい見込みリストを作り、月曜朝から動けるように準備する', tags: ['行動変容', '自己効力'] },
      { label: 'B', text: 'この3ヶ月で築いた先方との関係は資産だと考え、半年後に再アプローチする計画を立てる', tags: ['合理化・俯瞰', '行動変容'] },
      { label: 'C', text: '「3ヶ月が無駄だった」という気持ちが消えず、しばらく新規開拓のモチベーションが出ない', tags: ['回避・撤退'] },
      { label: 'D', text: '予算凍結は自分にはどうしようもないことなので、深く考えずに次に行く', tags: ['感情制御', '合理化・俯瞰'] },
    ],
  ...
  },
  {
    ...
    sjtOptions: [
      { label: 'A', text: 'マネージャーに1on1を申し込み、「自分に何が足りないか」を率直に聞く', tags: ['フィードバック志向', 'チーム志向'] },
      { label: 'B', text: '他の3人のやり方を観察・模倣して、まず同じ水準まで追いつこうとする', tags: ['フィードバック志向', '行動変容'] },
      { label: 'C', text: '自分にはこの環境が合っていないのかもしれないと思い、別のインターン先を探し始める', tags: ['合理化・俯瞰', '回避・撤退'] },
      { label: 'D', text: '焦りはあるが、自分なりのやり方を見つけながら追いつこうとする', tags: ['自己効力', '情熱駆動'] },
    ],
