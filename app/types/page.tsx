...
// Detail section: quadrants ordered top→bottom, keys within each sorted by axis
// Within quadrant: OS-H first (top), then SE-H first (right)
const DETAIL_QUADRANTS = [
  {
    id: 'executor',
    label: '実行者ゾーン',
    position: 'PE-H / ES-H',
